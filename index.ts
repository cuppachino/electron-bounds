/// This module is a helper for persisting and restoring the window size and position between sessions.
import { type BrowserWindow, screen } from "electron";
import Store from "electron-store";
import yaml from "js-yaml";

type ReplaceReturn<T extends (...args: any[]) => unknown, U> = (
  ...a: Parameters<T>
) => U;
...
export const store = new Store<Bounds>({
  schema,
  fileExtension: "yaml",
  serialize: yaml.dump,
